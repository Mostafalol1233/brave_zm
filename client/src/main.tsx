...
createRoot(document.getElementById("root")!).render(
  <HelmetProvider>
    <Helmet>
      <title>GameHeroes - Legendary Characters</title>
      <meta name="description" content="Discover our exclusive collection of powerful game characters that will take your gaming experience to the next level. GameHeroes offers premium character upgrades with instant delivery." />
