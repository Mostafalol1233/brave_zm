        ...
        >
          ...
          <div className="flex flex-col space-y-4 mb-8 mt-6">
            ...
            >
              <Link
                href="/shop"
                className="inline-block w-full bg-red-600 hover:bg-red-700 text-white text-lg font-bold py-4 px-6 rounded-lg transition duration-300"
              >
            ...
            >
              <Link
                href="/connect"
                className="inline-block w-full bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-bold py-4 px-6 rounded-lg transition duration-300"
              >
                Connect With Us
              </Link>
            </motion.div>
            ...
            >
              <Link
                href="/about"
                className="inline-block w-full bg-green-600 hover:bg-green-700 text-white text-lg font-bold py-4 px-6 rounded-lg transition duration-300"
              >
                About Our Team
              </Link>
            </motion.div>
